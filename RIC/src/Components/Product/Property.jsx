...
import "./property.css";
import amenitiesData from "../Form/amenitiesData";
            ...
            <div className="property-card">
              ...
              <div className="property-info">
                ...
                <div className="property-features">
                  <h3 className="sellerform-label">Property Information</h3>
                  ...
                  <h3 className="sellerform-label">Plot Availability</h3>
                ...
                <label className="sellerform-label">Selected Features</label>
                  ...
                  {Object.keys(amenitiesData).map((amenity) => (
                    <div key={amenity}>
                      <div className="amenity-item">
                        <input
                          type="checkbox"
                          checked={!!details.selectedAmenities[amenity]}
                          readOnly
                        />
                        <label>{amenity}</label>
                      </div>

                      {details.selectedAmenities[amenity] && (
                        <div className="subcategory-container">
                          {amenitiesData[amenity].map((sub, idx) => (
                            <div key={idx} className="subcategory-item">
                              <input
                                type="checkbox"
                                checked={details.selectedAmenities[
                                  amenity
                                ]?.includes(sub)}
                                readOnly
                              />
